...
from .views import login_view, patient_list, patient_detail, prediction_page, guideline_page, process_user_input, logout_view, track_link_click, record_hover_event
